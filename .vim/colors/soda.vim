...
if exists("syntax_on")
  syntax reset
	...
	hi LineNr ctermfg=250 ctermbg=255 cterm=NONE guifg=#aaaaaa guibg=#eeeeee gui=NONE
	hi VertSplit ctermfg=255 ctermbg=255 cterm=NONE guifg=#cecece guibg=#cecece gui=NONE
	...
	hi Define ctermfg=161 ctermbg=231 cterm=NONE guifg=#bc670f guibg=#fffdf7 gui=NONE
	...
	hi Label ctermfg=161 ctermbg=231 cterm=NONE guifg=#bc670f guibg=#fffdf7 gui=NONE
	...
	hi String ctermfg=161 ctermbg=231 cterm=NONE guifg=#bc670f guibg=#fffdf7 gui=NONE
